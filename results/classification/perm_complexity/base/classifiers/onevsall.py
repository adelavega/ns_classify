...
def region_heatmap(clf, basename=None, zscore_regions=False, zscore_features=False, thresh=None, subset=None, alternate_labels=None, cmap=None, size=(15, 10)):
    ...
    heat_map(fi.T, clf.feature_names, np.array(subset) + 1, file_name = file_name, cmap=cmap, size=size)
