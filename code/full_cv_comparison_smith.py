...
match_region = nib.load('/home/delavega/projects/classification/masks/yeo_njeurophys/17_liberal_2mm.nii.gz')
from nilearn.image import resample_img
match_region = resample_img(match_region, target_affine=nib.load('masks/craddock/scorr_05_2level/%d.nii.gz' % 110).get_affine())
